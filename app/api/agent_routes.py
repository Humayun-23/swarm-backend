...
async def prepare_emails(
    ...
    try:
        ...
        # Extract template variations for user selection
        templates_variations = result_state.get("email_templates", {})
        ...
        if request.send_immediately:
            ...
            # Return template variations for user to choose from, along with prepared emails
            results_payload = {
                "prepared": len(result_state.get("emails_sent", [])),
                "emails_prepared": result_state.get("emails_sent", []),
                "template_variations": templates_variations
            }
